<template>
    <Form label-position="top" ref="modelForm" :model="modelForm" :rules="modelFormRule">
        ...
        <FormItem label="所属部门" prop="selecteddeparts">
            <treeselect placeholder="请选择所属部门" :normalizer="departTreeNormalizer" v-model="modelForm.selecteddeparts"
                :multiple="true" :options="departTreeList">
            </treeselect>
        </FormItem>
...
<script>
    ...
    export default {
        ...
        methods: {
                    ...
                    USER_QUERY_SERVICE({
                        ...
                        if (response.success) {
                            ...
                            if (!_.isNil(result)) {
                                ...
                                this.modelForm.selectedroles = this.modelForm.selectedroles || [];
                                this.modelForm.selecteddeparts = this.modelForm.selecteddeparts || [];
            ...
            getDepartTreeList() {
                DEPART_TREE_LIST_SERVICE().then(response => {
            ...
            onSaveUser() {
                ...
                this.$refs['modelForm'].validate((valid) => {
                    if (valid) {
                        ...
                        vm.modelForm.selectedroles = _.join([vm.modelForm.selectedroles], ',') || [];
                        vm.modelForm.selecteddeparts = _.join([vm.modelForm.selecteddeparts], ',') || [];
