                ...
                <Menu-Item :name="item.id" :key="index">
                    ...
                    <template v-if="item.statusCode==0">
                        ...
                        <Tooltip content=" 已停用" placement="right">
                            <label style="color: #8C8C8C;cursor: not-allowed;" v-text="item.name"></label>
                        </Tooltip>

                    </template>
                    <template v-else>
                        <label :class="item.menuClass" :style="item.menuStyle" v-text="item.name"></label>
                    </template>
